...
<head>
    ...
    <style>
        ...
        #myInput {
            background-image: url('/bootstrap/icon.png'); /* Add a search icon to input */
    ...
    <div data-role="content">
        <div class="container">
            ...
            <div>
                ...
                <br>
                <input type="text" id="myInput" onkeyup="myFunc()" name="search" placeholder="Search Title..">
            </div>
            <br>
            ...
            <div style="width: 100%; overflow-x: auto">
                <table id="myTable" data-role="table" class="table table-dark">
                    ...
                    <c:forEach items="${items}" var="Item">
                        ...
                        <tr>
                            ...
                            <td>
                                <a data-transition="pop" class="btn btn-info create"
                                   href="/servlets/edit.jsp?id=${Item.ID}&title=${Item.title}&desc=${Item.description}&imp=${Item.levelOfImp}&date=${Item.date} ">Edit</a>
                                <a data-transition="pop" class="btn btn-info create"
                                   href="/servlets/delete.jsp?id=${Item.ID}">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
